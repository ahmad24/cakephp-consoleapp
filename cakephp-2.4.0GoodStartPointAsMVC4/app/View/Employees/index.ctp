	...
	<div class="col-md-8 ">
		<div class="panel panel-primary">
			<div class="panel-heading">
			  <h3 class="panel-title"><?php echo __('Employees'); ?>  </h3>
			</div>
...
<div class="employees index">
	...
	<tr>
						...
						<th><?php echo $this->Paginator->sort('employee_categorie_id'); ?></th>
	...
	<tr>
		...
		<td><?php echo h($employee['Employee']['birthdate']); ?>&nbsp;</td>
		<td><?php echo h($employee['Employee']['employment']); ?>&nbsp;</td>
		<td><?php echo h($employee['Employee']['identity']); ?>&nbsp;</td>
		<td>
			<?php echo $this->Html->link($employee['User']['id'], array('controller' => 'users', 'action' => 'view', $employee['User']['id'])); ?>
		</td>
		<td class="actions">
			<?php echo $this->Html->link('', array('action' => 'view', $employee['Employee']['id']),array('class'=>'glyphicon glyphicon-search')); ?>
			<?php echo $this->Html->link('', array('action' => 'edit', $employee['Employee']['id']),array('class'=>'glyphicon glyphicon-wrench')); ?>
			<?php echo $this->Form->postLink('', array('action' => 'delete', $employee['Employee']['id']), array('class'=>'glyphicon glyphicon-trash'), __('Are you sure you want to delete # %s?', $employee['Employee']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
