	...
	<div class="col-md-8 ">
		<div class="panel panel-primary">
			<div class="panel-heading">
			  <h3 class="panel-title"><?php echo __('Edit Post'); ?></h3>
			</div>
			<div class="panel-body">
				<?php echo $this->Form->create('', array('class'=>'form-horizontal')); ?>				
					<div class="form-group"><?php 
											...
											echo $this->Form->label('title', Inflector::humanize('title') ,array('class'=>'col-sm-2 control-label'));
											...
											echo $this->Form->label('body', Inflector::humanize('body') ,array('class'=>'col-sm-2 control-label'));
