	...
	<div class="col-md-8 ">
		<div class="panel panel-primary">
			<div class="panel-heading">
			  <h3 class="panel-title"><?php echo __('Edit Log Category'); ?></h3>
			</div>
			<div class="panel-body">
				<?php echo $this->Form->create('', array('class'=>'form-horizontal')); ?>				
					<div class="form-group"><?php 
											...
											echo $this->Form->label('order', Inflector::humanize('order') ,array('class'=>'col-sm-2 control-label'));
											...
											echo $this->Form->label('visible', Inflector::humanize('visible') ,array('class'=>'col-sm-2 control-label'));
