 ...
 */
	public function add() {
		...
		$cards = $this->Test->Card->find('list');
		$testCategories = $this->Test->TestCategorie->find('list');
		$employees = $this->Test->Employee->find('list');
		$users = $this->Test->User->find('list');
		$this->set(compact('cards', 'testCategories', 'employees', 'users'));
	}
